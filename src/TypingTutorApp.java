...
public class TypingTutorApp {
	...
	static CrossingWord crossingWord;
	static HungryWordMover[] hungryMovers;
	...
	public static void setupGUI(int frameX, int frameY, int yLimit) {
		...
		gameWindow = new GamePanel(words, yLimit, done, started, won, crossingWord);
	...
	public static void createWordMoverThreads() {
		...
		for (int i = 0; i < noWords; i++) {
			...
			// crossingWords[i] = new CrossingWord(dict.getNewWord(),
			// gameWindow.getValidYpos(), xLimit); // *********************
		...
		hungryWordMover = new HungryWordMover(crossingWord, dict, score, startLatch, done, pause);
		// hungryMovers = new HungryWordMover(crossingWord, dict, score, startLatch,
		// done, pause);
		// word movers waiting on starting line
		hungryWordMover.start();
		for (int i = 0; i < noWords; i++) {
			wrdShft[i].start();
			// hungryMovers[i].start(); //
			// **************************************************************************
		}
	...
	public static void main(String[] args) {
		...
		hungryMovers = new HungryWordMover[noWords]; // *********************************************************************
		crossingWord = new CrossingWord(dict.getNewWord(), xLimit, 300);
