...
public class GamePanel extends JPanel implements Runnable {
	...
	private CrossingWord crossingWord;
	...
	GamePanel(FallingWord[] words, int maxY,
			AtomicBoolean d, AtomicBoolean s, AtomicBoolean w, CrossingWord crossingWord) {
		this.crossingWord = crossingWord;
	...
	public void paintComponent(Graphics g) {
		...
		if (!started.get()) {
			...
			g.drawString(crossingWord.getWord(), crossingWord.getX() + borderWidth,
					crossingWord.getY());
